...
public class AllureSqlLogger extends StdoutLogger {
    ...
    private final AttachmentRenderer attachmentRenderer = new FreemarkerAttachmentRenderer("sql-query-allure-template.ftl");
    ...
    public void logSQL(int connectionId, String now, long elapsed, Category category, String prepared, String sql, String url) {
        ...
        if (isNotEmpty(sql) && isNotEmpty(prepared)){
            SqlRequestAttachment sqlRequestAttachment = new SqlRequestAttachment("SQL QUERY",sql,prepared);
            attachmentProcessor.addAttachment(sqlRequestAttachment,attachmentRenderer);
        }
    }
}
